export const removeExistingSubscribedAddressesDoc = `<SCL xmlns="http://www.iec.ch/61850/2003/SCL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2007" revision="B" release="4" xmlns:etpc="https://transpower.co.nz/SCL/SCD/Communication/v1">
<Header id="Test"/>
<Communication>
    <SubNetwork name="ProcessBus" desc="" type="8-MMS">
        ...
        <ConnectedAP iedName="SMV_Subscriber" apName="AP1"><Private type="Transpower-SMV-Subscribe" etpc:iedName="SMV_Publisher" etpc:cbName="fullSmv" etpc:ldInst="CurrentTransformer"><etpc:Address><etpc:P type="VLAN-ID" xsi:type="tP_VLAN-ID">3EE</etpc:P><etpc:P type="VLAN-PRIORITY" xsi:type="tP_VLAN-PRIORITY">4</etpc:P><etpc:P type="MAC-Address" xsi:type="tP_MAC-Address">01-0C-CD-04-00-02</etpc:P></etpc:Address></Private></ConnectedAP>
    ...
    <SubNetwork name="StationBus" desc="" type="8-MMS">
        ...
        <ConnectedAP apName="AP1" iedName="GOOSE_Subscriber2"><Private type="Transpower-GSE-Subscribe" etpc:iedName="GOOSE_Publisher" etpc:cbName="GOOSE2" etpc:ldInst="QB2_Disconnector"><etpc:Address><etpc:P type="VLAN-ID" xsi:type="tP_VLAN-ID">3EE</etpc:P><etpc:P type="VLAN-PRIORITY" xsi:type="tP_VLAN-PRIORITY">4</etpc:P><etpc:P type="MAC-Address" xsi:type="tP_MAC-Address">01-0C-CD-01-01-01</etpc:P></etpc:Address></Private><Private type="Transpower-GSE-Subscribe" etpc:iedName="GOOSE_Publisher2" etpc:cbName="GOOSE2" etpc:ldInst="QB2_Disconnector"><etpc:Address><etpc:P type="MAC-Address" xsi:type="tP_MAC-Address">01-0C-CD-01-00-01</etpc:P></etpc:Address></Private></ConnectedAP><ConnectedAP apName="AP1" iedName="GOOSE_Subscriber"><Private type="Transpower-GSE-Subscribe" etpc:iedName="GOOSE_Publisher" etpc:cbName="GOOSE2" etpc:ldInst="QB2_Disconnector"><etpc:Address><etpc:P type="VLAN-ID" xsi:type="tP_VLAN-ID">3EE</etpc:P><etpc:P type="VLAN-PRIORITY" xsi:type="tP_VLAN-PRIORITY">4</etpc:P><etpc:P type="MAC-Address" xsi:type="tP_MAC-Address">01-0C-CD-01-01-01</etpc:P></etpc:Address></Private><Private type="Transpower-GSE-Subscribe" etpc:iedName="GOOSE_Publisher2" etpc:cbName="GOOSE2" etpc:ldInst="QB2_Disconnector"><etpc:Address><etpc:P type="MAC-Address" xsi:type="tP_MAC-Address">01-0C-CD-01-00-01</etpc:P></etpc:Address></Private></ConnectedAP><ConnectedAP iedName="GOOSE_Publisher" apName="AP1">
