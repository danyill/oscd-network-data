export const getUsedCBsDoc = `<?xml version="1.0" encoding="UTF-8"?>
<SCL xmlns="http://www.iec.ch/61850/2003/SCL" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                ...
                <LDevice inst="CurrentTransformer">
                    <LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0">
                        <DataSet name="fullSmvsDataSet">
                            <FCDA ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3"
                                doName="AmpSv" daName="instMag.i" fc="MX" />
                            <FCDA ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3"
                                doName="AmpSv" daName="q" fc="MX" />
                            <FCDA ldInst="CurrentTransformer" prefix="L2" lnClass="TCTR" lnInst="2"
                                doName="AmpSv" daName="instMag.i" fc="MX" />
                            <FCDA ldInst="CurrentTransformer" prefix="L2" lnClass="TCTR" lnInst="2"
                                doName="AmpSv" daName="q" fc="MX" />
                            <FCDA ldInst="CurrentTransformer" prefix="L1" lnClass="TCTR" lnInst="1"
                                doName="AmpSv" daName="instMag.i" fc="MX" />
                            <FCDA ldInst="CurrentTransformer" prefix="L1" lnClass="TCTR" lnInst="1"
                                doName="AmpSv" daName="q" fc="MX" />
                            <FCDA ldInst="VoltageTransformer" prefix="L3" lnClass="TVTR" lnInst="3"
                                doName="VolSv" daName="instMag.i" fc="MX" />
                            <FCDA ldInst="VoltageTransformer" prefix="L3" lnClass="TVTR" lnInst="3"
                                doName="VolSv" daName="q" fc="MX" />
                            <FCDA ldInst="VoltageTransformer" prefix="L2" lnClass="TVTR" lnInst="2"
                                doName="VolSv" daName="instMag.i" fc="MX" />
                            <FCDA ldInst="VoltageTransformer" prefix="L2" lnClass="TVTR" lnInst="2"
                                doName="VolSv" daName="q" fc="MX" />
                            <FCDA ldInst="VoltageTransformer" prefix="L1" lnClass="TVTR" lnInst="1"
                                doName="VolSv" daName="instMag.i" fc="MX" />
                            <FCDA ldInst="VoltageTransformer" prefix="L1" lnClass="TVTR" lnInst="1"
                                doName="VolSv" daName="q" fc="MX" />
                        </DataSet>
                        ...
                        <SampledValueControl name="fullSmv" multicast="true" smvID="smv3"
                            smpMod="SmpPerPeriod" smpRate="80" nofASDU="1" confRev="1"
                            datSet="fullSmvsDataSet">
                            <SmvOpts sampleRate="true" dataSet="true" synchSourceId="true" />
                        </SampledValueControl>
                        <SampledValueControl name="voltageOnly" multicast="true" smvID="smv2"
                            smpMod="SmpPerPeriod" smpRate="80" nofASDU="1" confRev="1"
                            datSet="voltageOnlysDataSet">
                            <SmvOpts sampleRate="true" dataSet="true" synchSourceId="true" />
                        </SampledValueControl>
                        <SampledValueControl name="currrentOnly" multicast="true" smvID="firstSMV"
                            smpMod="SmpPerPeriod" smpRate="80" nofASDU="1" confRev="1"
                            datSet="currrentOnlysDataSet">
                            <SmvOpts sampleRate="true" dataSet="true" synchSourceId="true" />
                        </SampledValueControl>
                        <SampledValueControl name="currrentOnlyDifferentAp" multicast="true"
                            smvID="firstSMV" smpMod="SmpPerPeriod" smpRate="80" nofASDU="1"
                            confRev="1" datSet="currrentOnlysDataSet">
                            <SmvOpts sampleRate="true" dataSet="true" synchSourceId="true" />
                        </SampledValueControl>
                    </LN0>
                ...
                <LDevice inst="QB2_Disconnector" desc="Animalia">
                    <LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0">
                        <DataSet name="GOOSE2sDataSet">
                            <FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1"
                                doName="Pos" daName="stVal" fc="ST" />
                            <FCDA ldInst="QB2_Disconnector" prefix="" lnClass="CSWI" lnInst="1"
                                doName="Pos" daName="q" fc="ST" />
                        </DataSet>
                        <DataSet name="GOOSE1sDataSet">
                            <FCDA ldInst="QB1_Disconnector" prefix="" lnClass="CSWI" lnInst="1"
                                doName="Pos" daName="stVal" fc="ST" />
                            <FCDA ldInst="QB1_Disconnector" prefix="" lnClass="CSWI" lnInst="1"
                                doName="Pos" daName="q" fc="ST" />
                        </DataSet>
                        <GSEControl name="GOOSE3" type="GOOSE" appID="GOOSE3" confRev="1"
                            datSet="GOOSE1sDataSet" />
                        <GSEControl name="GOOSE2" type="GOOSE" appID="GOOSE2" confRev="1"
                            datSet="GOOSE2sDataSet" />
                        <GSEControl name="GOOSE1" type="GOOSE" appID="GOOSE1" confRev="1"
                            datSet="GOOSE1sDataSet" />
                    </LN0>
        ...
        <AccessPoint name="AP1">
            <Server>
                ...
                <LDevice inst="Earth_Switch">
                    <LN0 lnClass="LLN0" inst="" lnType="Dummy.LLN0">
                        <Inputs>
                            <ExtRef iedName="GOOSE_Publisher" serviceType="GOOSE"
                                ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix=""
                                doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector"
                                srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" />
                            <ExtRef iedName="GOOSE_Publisher2" serviceType="GOOSE"
                                ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix=""
                                doName="Pos" daName="q" srcLDInst="QB2_Disconnector" srcPrefix=""
                                srcLNClass="LLN0" srcCBName="GOOSE2" />
                        </Inputs>
                    </LN0>
                    <LN prefix="" lnClass="CILO" inst="1" lnType="Dummy.CILO">
                        <Inputs>
                            <ExtRef iedName="SomethingNotPresent" intAddr="Pos;CSWI1/Pos/stVal"
                                desc="Missing IED" serviceType="GOOSE" ldInst="QB2_Disconnector"
                                lnClass="CSWI" lnInst="1" prefix="" doName="Pos" daName="stVal"
                                srcLDInst="QB2_Disconnector" srcPrefix="" srcLNClass="LLN0"
                                srcCBName="GOOSE2" />
                            <ExtRef iedName="GOOSE_Publisher" intAddr="Pos;CSWI1/Pos/q"
                                desc="Missing attributes" serviceType="GOOSE"
                                ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix=""
                                daName="q" srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2" />
                        </Inputs>
                    </LN>
                    <LN prefix="" lnClass="CSWI" inst="1" lnType="Dummy.CSWI">
                        <Inputs>
                            <ExtRef iedName="GOOSE_Publisher" serviceType="GOOSE"
                                ...
                                doName="Pos" daName="stVal" srcLDInst="QB2_Disconnector"
                                srcPrefix="" srcLNClass="LLN0" srcCBName="GOOSE2"
                                intAddr="Pos;CSWI1/Pos/stVal" desc="Interlocking.Input2" />
                            <ExtRef iedName="GOOSE_Publisher" serviceType="GOOSE"
                                ldInst="QB2_Disconnector" lnClass="CSWI" lnInst="1" prefix=""
                                doName="Pos" daName="q" srcLDInst="QB2_Disconnector" srcPrefix=""
                                srcLNClass="LLN0" srcCBName="GOOSE2DoesNotExist"
                                intAddr="Pos;CSWI1/Pos/q" desc="Interlocking.Input2" />
                            <ExtRef intAddr="someRestrictedExtRef" desc="Restricted To Pos"
                                pLN="CSWI" pDO="Pos" pDA="stVal" pServT="GOOSE" />
                        </Inputs>
                    </LN>
                    <LN prefix="" lnClass="XSWI" inst="1" lnType="Dummy.XSWI" />
                </LDevice>
    ...
    <IED name="GOOSE_Subscriber2" manufacturer="Dummy">
        <AccessPoint name="AP1">
            <Server>
                <Authentication />
                <LDevice inst="Earth_Switch">
                    ...
                    <LN prefix="" lnClass="PTRC" inst="1" lnType="Summy.PTRC">
                        <Inputs>
                            ...
                            <ExtRef intAddr="AmpSv;TCTR2/AmpSv/instMag.i" desc="MeasPoint.CT2"
                                iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3"
                                lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i"
                                srcLDInst="CurrentTransformer" srcPrefix="NoMatch" srcLNClass="LLN0"
                                srcCBName="fullSmv" serviceType="SMV" />
                            <ExtRef intAddr="AmpSv;TCTR2/AmpSv/q" desc="MeasPoint.CT1" />
                            <ExtRef intAddr="AmpSv;TCTR3/AmpSv/instMag.i" desc="MeasPoint.CT3"
                                iedName="SMV_Publisher" ldInst="CurrentTransformer" prefix="L3"
                                lnClass="TCTR" lnInst="3" doName="AmpSv" daName="instMag.i"
                                srcLDInst="CurrentTransformer" srcPrefix="" srcLNClass="LLN0"
                                srcCBName="fullSmv" serviceType="SMV" />
                            <ExtRef intAddr="AmpSv;TCTR3/AmpSv/q" desc="MeasPoint.CT1"
                                serviceType="SMV" iedName="SMV_Publisher"
                                ldInst="CurrentTransformer" prefix="L3" lnClass="TCTR" lnInst="3"
                                doName="AmpSv" daName="q" srcLDInst="CurrentTransformer"
                                srcPrefix="" srcLNClass="LLN0" srcCBName="fullSmv" />
                ...
                <LDevice inst="Overcurrent">
                    ...
                    <LN prefix="" lnClass="PTRC" inst="1" lnType="Summy.PTRC">
                        <Inputs>
                            ...
                            <ExtRef intAddr="someRestrictedExtRef" desc="Restricted To AmpSV"
                                pLN="TCTR" pDO="AmpSV" pDA="instMag.i" />
                        </Inputs>
                    </LN>
                </LDevice>
